...
function SliderUpdate() {
    ...
    useEffect(function () {
        (async function () {
            await slider_service.getById(id).then(function (result) {
    ...
    async function sliderEdit(event) {
        ...
        await slider_service.update(slider, id).then(function (res) {
    ...
    useEffect(function () {
        (async function () {
            await slider_service.getAll().then(function (result) {
