...
function ProductUpdate() {
    ...
    useEffect(function () {
        (async function () {
            await product_service.getById(id).then(function (result) {
    ...
    useEffect(function () {
        (async function () {
            await product_service.getAll().then(function (result) {
    ...
    useEffect(function () {
        (async function () {
            await brand_service.getAll().then(function (result) {
    ...
    async function productEdit(event) {
        ...
        await product_service.update(product, id).then(function (res) {
