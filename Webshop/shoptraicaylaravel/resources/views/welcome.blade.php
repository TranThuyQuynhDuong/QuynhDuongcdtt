					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i> duongtran3858@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>MIN</span>-FRUITS</h1>
									<h2>TRÁI CÂY NHẬP KHẨU TƯƠI NGON</h2>
									<p>Với hơn 5 năm kinh nghiệm trong lĩnh vực trái cây và thực phẩm nhập khẩu cũng như quà biếu, MIN thực sự đem đến nhiều lựa chọn phù hợp với nhiều yêu cầu của khách hàng là cá nhân cũng như là các công ty. </p>
									<button type="button" class="btn btn-default get">XEM THÊM</button>
								</div>
								<div class="col-sm-6">
									<img src="{{('public/frontend/images/girl11.jpg')}}" class="girl img-responsive" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
									<h1><span>MIN</span>-FRUITS</h1>
									<h2>Cherry New Zealand</h2>
									<p>GIÒN, NGỌT, SIÊU NGON. </p>
									<button type="button" class="btn btn-default get">MUA NGAY</button>
								</div>
								<div class="col-sm-6">
									<img src="{{('public/frontend/images/girl20.jpg')}}" class="girl img-responsive" alt="" />
								</div>
							</div>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>MIN</span>-FRUITS</h1>
									<h2>Dâu tây Hàn Quốc</h2>
									<p>NGỌT, THƠM, NGẤT NGÂY. </p>
									<button type="button" class="btn btn-default get">MUA NGAY</button>
								</div>
								<div class="col-sm-6">
									<img src="{{('public/frontend/images/girl33.jpg')}}" class="girl img-responsive" alt="" />
								</div>
							</div>
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<h2><span>MIN</span>-shopper</h2>
							<p>Với kinh nghiệm trong lĩnh vực trái cây khẩu, MIN đem đến nhiều lựa chọn yêu cầu của khách hàng.</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<div class="address">
							<img src="{{('public/frontend/images/map.pn')}}" alt="" />
